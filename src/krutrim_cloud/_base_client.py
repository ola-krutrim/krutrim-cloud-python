...
def platform_headers(version: str, *, platform: Platform | None) -> Dict[str, str]:
    return {
        "X-Krutrim-Cloud-Lang": "python",
        "X-Krutrim-Cloud-Package-Version": version,
        "X-Krutrim-Cloud-OS": str(platform or get_platform()),
        "X-Krutrim-Cloud-Arch": str(get_architecture()),
        "X-Krutrim-Cloud-Runtime": get_python_runtime(),
        "X-Krutrim-Cloud-Runtime-Version": get_python_version(),
    }
